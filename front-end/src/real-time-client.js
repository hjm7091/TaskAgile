...
class RealTimeClient {
  ...
  _processQueues () {
    ...
    console.log('[RealTimeClient] subscribeQueue', this.subscribeQueue)
    ...
    console.log('[RealTimeClient] unsubscribeQueue', this.unsubscribeQueue)
  ...
  _addToSubscribeQueue (channel, handler) {
    console.log('[RealTimeClient] Adding channel subscribe to queue. Channel: ' + channel + ', handler: ' + handler)
  ...
  _addToUnsubscribeQueue (channel, handler) {
    console.log('[RealTimeClient] Adding channel unsubscribe to queue. Channel: ' + channel + ', handler: ' + handler)
  ...
  _removeFromQueue (queue, channel, handler) {
    ...
    // console.log('[RealTimeClient] handlers', handlers)
    if (handlers) {
